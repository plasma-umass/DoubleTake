...
public:
    ...
    unsigned long pagestart;
		...
		start = MM::mmapAllocatePrivate (PAGE_ENTRY_NUM * sizeof(pageinfo), -1);
    pagestart = (unsigned long)MM::mmapAllocatePrivate(xdefines::PageSize * PAGE_ENTRY_NUM, -1);
